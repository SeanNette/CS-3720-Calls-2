...
public class PhysicianWindow {
    ...
    public JPanel createCustomerPanel() {
        ...
        JLabel customerL = new JLabel("The Physician Screen",
    ...
    private JPanel customerLeftPanel() {
        ...
        customerLeft.setLayout(new GridLayout(1, 1));
    ...
    private JPanel customerLeftLowerPanel() {
        ...
        //just quick try on listing physicians 
        //this is just a try.
        ...
        cList.setVisibleRowCount(20); // change
        //cList.addListSelectionListener(new ListListener());
        customerSP = new JScrollPane(cList);
        cVector = new Vector();
        int column = 20; //get column from 
        for (int i = 1; i < column; i++) {
            cVector.add(pBroker.selectPhysician(i, connect));
        }
...
//                                String sdate = startdate_TF.getText();
                    ...
                    System.out.print("true? " + didit);
                    if (didit) {
                        JOptionPane.showMessageDialog(null, "Added physician succefully.");
