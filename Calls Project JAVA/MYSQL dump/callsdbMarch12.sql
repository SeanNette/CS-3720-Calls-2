...
--
-- Current Database: `callsdb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `callsdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `physician` VALUES (1,'darek','zborowski','2011-01-01','2011-01-01','2011-01-01','251 dsakjda','4033138935'),(2,'chuj','ci','2012-01-01','2011-01-01','2011-01-01','w','123456789'),(3,'chuj','ci','2012-12-12','2011-01-01','2011-01-01','w','123456789'),(4,'evan','matejko','2012-01-01','2011-01-01','2011-01-01','12io3u18','123456789'),(5,'test2','test2','2012-12-12','2011-01-01','2011-01-01','TEST2','4033333333');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `addPhysician`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `deletePhysician`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `selectProcedure`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `updatePhysician`(
	IN Employee_ID 				int(10),
	IN in_First_Name 			 varchar(80),
	IN in_Last_Name 			 varchar(80),
	IN in_Birth_Date 			 date,
...
-- Dump completed on 2013-03-12 12:46:00
