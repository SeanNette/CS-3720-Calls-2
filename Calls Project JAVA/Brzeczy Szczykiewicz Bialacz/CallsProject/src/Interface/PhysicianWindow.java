...
public class PhysicianWindow {
	...
	private JPanel customerLeftPanel() {
		...
		customerLeft.setLayout(new GridLayout());
	...
	//	customerLeft.add(customerLeftLowerPanel());
                ...
                customerLeft.add(phys.showTable());
	...
	private class ClearButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == clearB) {
                            ...
                            createCustomerPanel().remove(customerLeftPanel());
                            createCustomerPanel().add(customerLeftPanel());
                            createCustomerPanel().validate();
			}
		}
	}
}
