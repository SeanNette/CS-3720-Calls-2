...
public class Interface extends JFrame {
    ...
    public void createWindow() {
        ...
        JPanel physicianPane = new JPanel();
        */
        
        PhysicianWindow physicianPanel = new PhysicianWindow();
        CalendarWindow calendarPanel = new CalendarWindow();
        
        //tabbedPane.addTab("Calendar", calendarPanel);
        tabbedPane.addTab("Physician", physicianPanel.createCustomerPanel());
	...
	public Interface() {
		...
		PhysicianWindow cw = new PhysicianWindow();
		panelList.add(cw.createCustomerPanel());
	}
